...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~(((icmp_ln17_fu_138_p2 == 1'd1) & (is_last_0_i_out_out_full_n == 1'b0)) | ((icmp_ln17_fu_138_p2 == 1'd0) & (in_data_0_vld_out == 1'b0))) & (icmp_ln17_fu_138_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~(((icmp_ln17_fu_138_p2 == 1'd1) & (is_last_0_i_out_out_full_n == 1'b0)) | ((icmp_ln17_fu_138_p2 == 1'd0) & (in_data_0_vld_out == 1'b0))) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        ...
        tmp_146_reg_509 <= {{select_ln581_fu_251_p3[11:4]}};
...
always @ (posedge ap_clk) begin
    if ((~(((icmp_ln17_fu_138_p2 == 1'd1) & (is_last_0_i_out_out_full_n == 1'b0)) | ((icmp_ln17_fu_138_p2 == 1'd0) & (in_data_0_vld_out == 1'b0))) & (icmp_ln17_fu_138_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if ((~(((icmp_ln17_fu_138_p2 == 1'd1) & (is_last_0_i_out_out_full_n == 1'b0)) | ((icmp_ln17_fu_138_p2 == 1'd0) & (in_data_0_vld_out == 1'b0))) & (icmp_ln17_fu_138_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) | (1'b1 == ap_CS_fsm_state4) | (~(((icmp_ln17_fu_138_p2 == 1'd1) & (is_last_0_i_out_out_full_n == 1'b0)) | ((icmp_ln17_fu_138_p2 == 1'd0) & (in_data_0_vld_out == 1'b0))) & (1'b1 == ap_CS_fsm_state2)))) begin
        grp_fu_135_ce = 1'b1;
    end else begin
        grp_fu_135_ce = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~(((icmp_ln17_fu_138_p2 == 1'd1) & (is_last_0_i_out_out_full_n == 1'b0)) | ((icmp_ln17_fu_138_p2 == 1'd0) & (in_data_0_vld_out == 1'b0))) & (icmp_ln17_fu_138_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if ((~(((icmp_ln17_fu_138_p2 == 1'd1) & (is_last_0_i_out_out_full_n == 1'b0)) | ((icmp_ln17_fu_138_p2 == 1'd0) & (in_data_0_vld_out == 1'b0))) & (icmp_ln17_fu_138_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_state2 = (((icmp_ln17_fu_138_p2 == 1'd1) & (is_last_0_i_out_out_full_n == 1'b0)) | ((icmp_ln17_fu_138_p2 == 1'd0) & (in_data_0_vld_out == 1'b0)));
end
...
assign i_fu_144_p2 = (i_0_i3_i_reg_124 + 10'd1);

assign icmp_ln17_fu_138_p2 = ((i_0_i3_i_reg_124 == 10'd784) ? 1'b1 : 1'b0);
...
assign icmp_ln603_fu_287_p2 = ((tmp_146_reg_509 == 8'd0) ? 1'b1 : 1'b0);
...
assign or_ln22_fu_159_p2 = (is_last_0_i_out_dc_0_reg_112 | in_last_V_0_data_out);
...
assign select_ln588_fu_312_p3 = ((tmp_147_fu_304_p3[0:0] === 1'b1) ? 16'd65535 : 16'd0);
...
assign tmp_147_fu_304_p3 = bitcast_ln696_1_fu_301_p1[32'd31];
