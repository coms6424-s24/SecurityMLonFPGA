...
HD_PWD='/home/fang/PycharmProjects/cnn_bo/HLS_projectsQkeras_pruned_CNN/hls4ml_PYNQ_prj_three/myproject_vivado_accelerator/project_1.runs/design_1_auto_pc_0_synth_1'
cd "$HD_PWD"
